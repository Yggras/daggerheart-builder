...
function reviewFor(scriptPath: string, cleanupLabels: string[], warnings: string[], accepted: boolean) {
  return {
    status: accepted ? ("reviewed" as const) : ("extracted" as const),
    ...
    notes: [
      ...
      ...(accepted ? ["Report-driven manual review accepted on 2026-05-26 with no flaws found."] : []),
